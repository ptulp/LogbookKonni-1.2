...
//	wxInitAllImageHandlers();
    ...
    // Grid
    m_gridMotorSails->CreateGrid( 0, 25 );
    ...
    m_gridMotorSails->SetColSize( 24, 219 );	
    ...
    m_gridMotorSails->SetColLabelValue( 8, _( "Jauge\nFuel" ) );	
    m_gridMotorSails->SetColLabelValue( 9, _( "Sails" ) );
    m_gridMotorSails->SetColLabelValue( 10, _( "Reef" ) );
    m_gridMotorSails->SetColLabelValue( 11, _( "Generator" ) );
    m_gridMotorSails->SetColLabelValue( 12, _( "Gen. total" ) );
    m_gridMotorSails->SetColLabelValue( 13, _( "Bank #1" ) );
    m_gridMotorSails->SetColLabelValue( 14, _( "AH #1 Total" ) );
    m_gridMotorSails->SetColLabelValue( 15, _( "Bank #2" ) );
    m_gridMotorSails->SetColLabelValue( 16, _( "AH #2 Total" ) );
    m_gridMotorSails->SetColLabelValue( 17, _( "Watermaker" ) );
    m_gridMotorSails->SetColLabelValue( 18, _( "W-Total" ) );
    m_gridMotorSails->SetColLabelValue( 19, _( "W-Output" ) );
    m_gridMotorSails->SetColLabelValue( 20, _( "Water" ) );
    m_gridMotorSails->SetColLabelValue( 21, _( "WaterTotal" ) );
    m_gridMotorSails->SetColLabelValue( 22, _( "Remarks" ) );
    m_gridMotorSails->SetColLabelValue( 23, _( "RouteID" ) );
    m_gridMotorSails->SetColLabelValue( 24, _( "TrackID" ) );
